			...
			if(u8Value_copy==INPUT)
				{
					...
					{
						case PORT0 :CLEAR_BIT( DDRA_REG,u8PinId_copy);
									break;
						case PORT1 :CLEAR_BIT( DDRB_REG,u8PinId_copy);
								    break;
						case PORT2 :CLEAR_BIT( DDRC_REG,u8PinId_copy);
									break;
						case PORT3 :CLEAR_BIT( DDRD_REG,u8PinId_copy);
									break;
}
	}
